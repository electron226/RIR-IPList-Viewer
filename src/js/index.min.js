...
success:function(a){var b;try{return g=a,r(0,h),b={view_record:h,total_record:a.length,nav_count:5},m=$("#view_pages").pagination(b)}catch(c){return console.log(c),alert(c)}},error:function(){return console.log("IP Search Error")},complete:function(){b.state("complete");return w.css("display","none")}})};s.GetViewTable=function(a){r((a-1)*h,a*h);return m.MakeNavigator(a)};r=function(a,b){var e,d,c;d="";for(e=c=a;a<=b?c<b:c>b;e=a<=b?++c:--c)null!=g[e]&&(d+="<tr>",d+="<td>"+escape(g[e].registry)+"</td>",
d+="<td>"+escape(g[e].country)+"</td>",d+="<td>"+escape(g[e].StartIP)+"</td>",d+="<td>"+escape(g[e].EndIP)+"</td>",d+="</tr>");return $("#viewbar tbody").html(d)};s.ChangeRow=function(a){h=a;$("#view_row .active").removeClass("active");$("#view_row li:eq("+u(a)+")").addClass("active");if(null!=m)return r(0,h),a={view_record:h,total_record:m.total_record,nav_count:5},m=$("#view_pages").pagination(a)};u=function(a){return a/50-1};A=null;$("button.sort_item").click(function(){var a,b,e;a=$(this);b=this.name;
...
b.registry?1:-1});break;case "sort_country":g.sort(function(a,b){return a.country<b.country?1:-1});break;case "sort_ip_start":g.sort(function(a,b){return a.start<b.start?1:-1});break;case "sort_ip_end":g.sort(function(a,b){return a.end<b.end?1:-1});break;default:throw"sort desc error.";}a.attr("value","asc")}s.ChangeRow(h);return A=b}catch(d){return console.log(d)}});$.fn.pagination=function(a){a.elements=null!=a.elements?a.elements:$(this);return new x(a)};$.fn.pagination.defaults={current_page:1,
...
a);b=t();if(v(b))return $.ajax({url:"/search",data:{search_ip:b},type:"GET",dataType:"json",success:function(e){var d,c,f,g,q,h,l;try{if(0<e.country.length){f={"\u691c\u7d22IP":b,"\u56fd\u540d\u30b3\u30fc\u30c9":e.country,"\u56fd\u540d":e.name};q="<table class='table'>";var p;p=[];for(g in f)c=f[g],p.push("<tr>                                       <td>"+g+"</td>                                       <td>"+c+"</td>                                   </tr>");h=0;for(l=p.length;h<l;h++)d=p[h],q+=d;q+=
...
l.attr("data-content","<p>\u6b63\u3057\u3044IP\u30a2\u30c9\u30ec\u30b9\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002</p>"+a);b=t();if(v(b))return b={domainName:b,outputFormat:"JSON"},$.ajax({url:"http://www.whoisxmlapi.com/whoisserver/WhoisService",data:b,type:"GET",crossDomain:!0,dataType:"jsonp",success:function(b){var d,c,f,g,h,i,j,p,k,n,o,m;try{j=b.WhoisRecord;h=j.rawText;if(null!=h)i=h.split("\n\n");else if(g=j.registryData.rawText,null!=g)i=g.split("\n\n");else throw"\u30ec\u30b3\u30fc\u30c9\u304c\u5b58\u5728\u3057\u307e\u305b\u3093\u3067\u3057\u305f\u3002";
f="";p=0;for(n=i.length;p<n;p++){d=i[p];f+='<div style="margin-bottom: 1em;">';m=d.split("\n");k=0;for(o=m.length;k<o;k++)c=m[k],f+="<p>"+$.trim(c)+"</p>";f+="</div>"}}catch(r){f=r}l.attr("data-original-title","Whois\u691c\u7d22\u7d50\u679c");return l.attr("data-content",f+a)},error:function(){return console.log("WhoisSearch Error")},complete:function(){k.css("display","none");return l.popover("show")}});k.css("display","none");l.popover("show")});$("#registry .save").click(function(){var a,b,e,d,
